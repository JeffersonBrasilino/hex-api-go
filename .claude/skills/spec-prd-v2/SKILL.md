...
---
Load the full skill by reading `.agentic/skills/spec-prd-v2/SKILL.md` before proceeding with any task. Its `references/` files (prd-template.md, notes-template.md) resolve relative to that directory.
